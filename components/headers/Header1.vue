...
const { header: { logo, nav, cta } } = useAppConfig()
    ...
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
      <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
        ...
        <NuxtLink :to="logo.link" class="flex items-center">
          <img :src="isDark ? logo.dark : logo.light" class="mr-3 h-6 sm:h-9" :alt="logo.name">
        ...
        <div class="flex items-center lg:order-2">
          ...
          <!-- CTA -->
          <NuxtLink v-if="cta" :to="cta.link" class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none dark:focus:ring-primary-800">
            {{ cta.name }}
          </NuxtLink>
        ...
        <!-- Menu -->
        <div id="mobile-menu" class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1">
